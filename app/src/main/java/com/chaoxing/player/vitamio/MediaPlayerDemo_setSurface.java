...
package com.chaoxing.player.vitamio;
...
public class MediaPlayerDemo_setSurface extends Activity implements OnBufferingUpdateListener,
    ...
    private String path = Environment.getExternalStorageDirectory() + File.separator + "media" + File.separator + "video.mp4";
